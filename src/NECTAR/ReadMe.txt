...
Usage examples:
	java -jar NECTAR_DYNAMIC ./net.txt ./
			These  are examples with the minimum parameters needed.
	java -jar NECTAR_DYNAMIC ./net.txt ./ 1.1,1.2,1.3,1.4,1.5,2.0,2.5,3.0,3.5,4.0 0.8 3 30
	...
	java -jar NECTAR_DYNAMIC ./net.txt ./ 1.5,3.5,5.0,10.0 0.7 4 30 3 99
